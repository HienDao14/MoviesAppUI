...
import com.example.movieappui.databinding.FilmItemBinding
import com.example.movieappui.domain.Data

class FilmListAdapter() : RecyclerView.Adapter<FilmListAdapter.FilmListViewHolder>() {
    ...
    inner class FilmListViewHolder(binding : FilmItemBinding) : RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FilmListViewHolder {
        ...
        return FilmListViewHolder(FilmItemBinding.inflate(LayoutInflater.from(parent.context)))
    }
